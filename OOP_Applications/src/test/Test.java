...
public class Test {
	...
	System.out.println(positionsWithJava.get(0).getName()); // gui designer
								// senior
	...
	try {
	    ha.enterApplication("james", "sw team leader"); // james is not
							    // competent in sql
	} catch (ApplicationException e) {
	    System.out.println(e.getMessage());
	}
	try {
	    ha.enterApplication("mary", "gui designer senior"); // mary has
								// already
								// applied for a
								// position
	} catch (ApplicationException e) {
